...
# for i in range(1):
#     oDataSet = DataSet()
#     base = np.loadtxt("LBP_FILES/M1_8b_RE_ELIAS.txt", usecols=(x for x in range(256)), delimiter=",")
#     classes = np.loadtxt("LBP_FILES/M1_8b_RE_ELIAS.txt", dtype=object, usecols=257, delimiter=",")
...
#         print j
#     oExp.addDataSet(oDataSet, description="  50 execucoes M=1 LBP=8b base BAUMMAN ")
#     print oDataSet
#     print
# oExp.save("OBJETOS/EXP_07_ACC_M1_50_LBP8b_BAUMMAN.txt")
# print oExp
# print min(svmVectors), max(svmVectors), np.average(svmVectors), np.std(svmVectors)
#
# ##############################################################################################################################

oExp = oExp.load("OBJETOS/EXP_07_ACC_M1_50_LBP8b_BAUMMAN.txt")
print oExp
